...
def preprocess_frame(frame):
    ...
    cropped_frame = grayscale_frame[15:-5, 20:-20]  # crop the roof and bottom info bar out
    normalized_frame = cropped_frame / 255  # normalize the cropped frame
    preprocessed_frame = transform.resize(normalized_frame, [100, 120])  # shrink the cropped frame
